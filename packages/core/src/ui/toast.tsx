...
import { buttonVariants } from "@nui/core";
      ...
      >
        {toasts.map((toast) => (
          <Toast.Root
            ...
            data-slot="toast"
            className={cn(
              "bg-popover absolute right-0 bottom-0 left-auto z-[calc(1000-var(--toast-index))] mr-0 flex w-full items-center justify-between gap-1.5 border bg-clip-padding p-4 shadow-lg transition-all [transition-property:opacity,transform] duration-200 ease-out select-none rounded-boxes",
