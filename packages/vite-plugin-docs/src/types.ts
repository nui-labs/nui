...
export interface PluginOptions {
  ...
  contentsDir?: string;
  /** Directory containing sample component demos (default: "src/samples") */
  samplesDir?: string;
...
/**
 * Collection of sample component demos (docs-specific)
 */
export interface Samples {
  /** Sample component demos for documentation */
