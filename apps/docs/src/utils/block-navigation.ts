import type { Block } from "@nui/vite-plugin-blocks";
...
export function getPrevNextBlocks(
  ...
  category: string,
): { prevBlock: Block | null; nextBlock: Block | null } {
 ...
 */
export function getBlockRoutePath(block: Block): string {
 ...
 */
export function getBlockCategories(blocks: Block[]): string[] {
