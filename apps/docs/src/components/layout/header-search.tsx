  ...
  return (
    <>
      ...
      <button
        ...
        className="flex h-8 w-8 sm:w-64 items-center justify-between rounded-md border border-input bg-muted p-2 text-sm text-muted-foreground shadow-xs transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
      >
